 ...
 */
function dateAnglaisVersFrancais($maDate)//on passe d'une date separée ac tirets à une date séparée par des "/".
{
    @list($annee, $mois, $jour) = explode('-', $maDate);//explode=separer une variable en plusieurs variables en fonction d'un caractère donné.
...
function getMois($date)
{
    ...
    unset($jour);//retire la variale jur pour obtenir le mois et l'année.
...
// fonction Naomie Touati retouchée
