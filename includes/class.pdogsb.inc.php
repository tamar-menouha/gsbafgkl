...
class PdoGsb
{
     ...
     */
    public static function getPdoGsb()//verifie si on est connecté à la bdd PhpMyAdmin 'PdoGsb', sinon elle va instancier la classe PdoGsb,cad relancer la bdd PdoGsb et ns connecter.
    {
